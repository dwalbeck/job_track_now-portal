                        ...
                        filteredReports.map((report) => (
                            <div key={report.company_id} className="report-card">
                                ...
                                <div className="card-row-5">
                                    <span className="created-date">{report.report_created ? `created` : ''}</span>
                                    <span className="created-date-date">{report.report_created ? `${report.report_created.split('T')[0]}` : ''}</span>
                                </div>
